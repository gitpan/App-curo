...
package App::curo_sync::Dispatcher;
...
my $program = {
    'App::curo_sync' => {
        'opt_spec' => [ [ 'debug|d', 'debug mode' ] ],
        'arg_spec' => [
            [
                'directory=s',
                'location of curo repository',
                { 'required' => 1 }
            ]
        ],
        'name'          => 'curo_sync',
        'usage_desc'    => 'usage: %c [options] DIRECTORY',
        'order'         => 2147483647,
        'class'         => 'App::curo_sync',
        'abstract'      => 'Sync Server for curo',
        'require_order' => 0,
        'getopt_conf'   => [ 'permute' ]
    }
};
...
App::curo_sync::Dispatcher - Dispatcher for App::curo_sync commands
...
B<App::curo_sync::Dispatcher> provides option checking, argument
checking, and command dispatching for commands implemented under the
App::curo_sync::* namespace.
...
Dispatch to a L<App::curo_sync> command based on the contents of @ARGV.
