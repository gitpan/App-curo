package App::curo::Config;

# This is simply a copy of Config::Tiny with encoding support. It will
# be removed once the Config-Tiny provides something similar.
...
App::curo::Config - Read/Write .ini style files with as little code as
possible
